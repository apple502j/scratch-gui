...
const MODAL_STAGE_RECORD = 'recordStageModal';
...
const openStageRecordModal = function () {
    return openModal(MODAL_STAGE_RECORD);
};
...
const closeStageRecordModal = function () {
    return closeModal(MODAL_STAGE_RECORD);
};
export {
    reducer as default,
